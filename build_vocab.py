...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='../tests/data/corpus_smiles.txt', help='path to th ecorpus')
    parser.add_argument('--out_path', '-o', type=str, default='../tests/data/vocab.pkl', help='output file')
